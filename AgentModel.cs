...
public class AgentModel : IObserver
{
    ...
    /*private static bool btemp = false;
    private static bool btemp2 = false;
    private static AgentModel tempAgent = null;*/
    // notice로 호출됨
    public void OnFixedUpdate()
    {
        ...
        {
            //SuppressAgent(tempAgent);
            SuppressAgent.Create(tempAgent, this);
            btemp2 = true;
        }*/
        ProcessAction();
