...
public class MapGraphRoot {
    private static MapGraphRoot _instance;
    public static MapGraphRoot instance
    {
        get
        {
            if (_instance == null)
                _instance = new MapGraphRoot();
            return _instance;
        }
    }
    ...
    private Dictionary<string, MapSefiraArea> nodeAreaTable;
    ...
    {
        MapSefiraArea area;
        if (nodeAreaTable.TryGetValue(name, out area))
        {
            area.ActivateArea();
        }
    }
    ...
    {
        foreach (MapSefiraArea area in nodeAreaTable.Values)
        {
            area.InitActivates();
        }
    }
    ...
    public void LoadMap()
    {
        ...
        Dictionary<string, MapSefiraArea> nodeAreaDic = new Dictionary<string, MapSefiraArea>();
        ...
        foreach (XmlNode areaNode in areaNodes)
        {
            ...
            nodeAreaDic.Add(areaName, mapArea);
